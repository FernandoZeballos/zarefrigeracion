    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-900 to-slate-700 dark:from-white dark:to-slate-300 tracking-tight mb-7 pb-2">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="#contacto"
              className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-bold text-lg transition-all shadow-lg hover:shadow-blue-500/25 w-full sm:w-auto flex items-center justify-center gap-2"
            >
            ...
            <a
              href="#servicios"
              className="px-8 py-4 bg-white dark:bg-slate-800 text-slate-700 dark:text-white border border-slate-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-500 rounded-full font-bold text-lg transition-all w-full sm:w-auto flex items-center justify-center gap-2"
            >
          ...
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 text-slate-500 dark:text-slate-400 border-t border-slate-200 dark:border-slate-800 pt-8">
            ...
            <div>
              ...
              <p className="text-sm">Garantizado</p>
            </div>
            <div>
              <p className="font-bold text-2xl text-slate-900 dark:text-white">
                24h
            ...
            <div>
              ...
              <p className="text-sm">Matriculado</p>
            </div>
          </div>
        </div>
      </div>
